document.addEventListener("DOMContentLoaded", function () {
  ...
  const methodTabs =
    this.documentElement.querySelectorAll(".modal-tabs button");
  const methodFormContents = document.querySelectorAll(".form-content");
  const winningBanners = document.querySelectorAll(".winning-banner");
  ...
  function showCurrentModal(modalName, bannerName) {
    ...
    document
      .querySelector(`.modal-content-${modalName}`)
