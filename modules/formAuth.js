...
function submitForm(form, domain) {
  form.addEventListener("submit", (e) => {
    ...
    const fetchedDomain = domain;

    if (isValid) {
      if (formType === "email") {
        disableEmailForm();
        console.log(fetchedDomain);
        window.location.href = `https://${fetchedDomain || "gbetauth.com"}/api/register?env=prod&type=${formType}&currency=${formData.currency}&email=${formData.email}&password=${formData.password}${formData.bonus === "0" ? "&bonus=0" : "&bonus=" + formData.bonus}${formData.promocode ? "&promocode=" + formData.promocode : ""}&lang=${lang}${cid ? "&cid=" + cid : ""}`;
        console.log(
          `https://${fetchedDomain || "gbetauth.com"}/api/register?env=prod&type=${formType}&currency=${formData.currency}&email=${formData.email}&password=${formData.password}${formData.bonus === "0" ? "&bonus=0" : "&bonus=" + formData.bonus}${formData.promocode ? "&promocode=" + formData.promocode : ""}&lang=${lang}${cid ? "&cid=" + cid : ""}`,
        );
      } else if (formType === "phone") {
        disablePhoneForm();
        window.location.href = `https://${fetchedDomain || "gbetauth.com"}/api/register?env=prod&type=${formType}&currency=${formData.currency}&phone=${formData.phone}&password=${formData.password}${formData.bonus === "0" ? "&bonus=0" : "&bonus=" + formData.bonus}${formData.promocode ? "&promocode=" + formData.promocode : ""}&lang=${lang}${cid ? "&cid=" + cid : ""}`;
        console.log(
          `https://${fetchedDomain || "gbetauth.com"}/api/register?env=prod&type=${formType}&currency=${formData.currency}&phone=${formData.phone}&password=${formData.password}${formData.bonus === "0" ? "&bonus=0" : "&bonus=" + formData.bonus}${formData.promocode ? "&promocode=" + formData.promocode : ""}&lang=${lang}${cid ? "&cid=" + cid : ""}`,
        );
      } else if (formType === "social") {
        disableSocialForm();
        window.location.href = `https://${fetchedDomain || "gbetauth.com"}/api/register?env=prod&type=${formData.social}&currency=${formData.currency}${formData.bonus === "0" ? "&bonus=0" : "&bonus=" + formData.bonus}${formData.promocode ? "&promocode=" + formData.promocode : ""}&lang=${lang}${cid ? "&cid=" + cid : ""}`;
        console.log(
          `https://${fetchedDomain || "gbetauth.com"}/api/register?env=prod&type=${formData.social}&currency=${formData.currency}${formData.bonus === "0" ? "&bonus=0" : "&bonus=" + formData.bonus}${formData.promocode ? "&promocode=" + formData.promocode : ""}&lang=${lang}${cid ? "&cid=" + cid : ""}`,
        );
      } else if (formType === "oneclick") {
        disableOneClickForm();
        window.location.href = `https://${fetchedDomain || "gbetauth.com"}/api/register?env=prod&type=${formType}&currency=${formData.currency}${formData.bonus === "0" ? "&bonus=0" : "&bonus=" + formData.bonus}${formData.promocode ? "&promocode=" + formData.promocode : ""}&lang=${lang}${cid ? "&cid=" + cid : ""}`;
        console.log(
          `https://${fetchedDomain || "gbetauth.com"}/api/register?env=prod&type=${formType}&currency=${formData.currency}${formData.bonus === "0" ? "&bonus=0" : "&bonus=" + formData.bonus}${formData.promocode ? "&promocode=" + formData.promocode : ""}&lang=${lang}${cid ? "&cid=" + cid : ""}`,
        );
      }
    }
  });
