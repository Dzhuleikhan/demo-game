...
formSocialLinks.forEach((link) => {
  if (link) {
    link.addEventListener("click", (e) => {
      ...
      // Раньше здесь язык гоняли через countryLanguagesMap как код страны
      // (lang.toUpperCase()), и это ломало 18 языков из 37: sv уезжал в es
      // («SV» — Сальвадор), ar в es (Аргентина), uk/cs/da/zh в en.
      // preferredLanguage уже хранит готовый код языка — берём его как есть.
      const lang = localStorage.getItem("preferredLanguage");
